            ...
            >
              <div className="flex justify-end text-lg gap-3 ">
                ...
                <MdOutlineEdit
                  ...
                  onClick={() => {
                    setEditPost(!editPost), setSelectedPost(post._id);
                  }}
                />
              </div>
              <h2
              ...
              <h3
                className="text-gray-500 font-semibold selection:bg-green-300 outline-none focus:bg-gray-200"
                contentEditable={editPost}
              ...
              <button
                ...
                } bg-purple-400 hover:bg-purple-600 px-2 py-1 my-1 rounded-md font-bold text-white `}
